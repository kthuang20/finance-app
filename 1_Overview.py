...
### add name to sidebar
st.sidebar.markdown("*Created by [Katie Huang](https://kthuang20.github.io/Katie_Portfolio/about/)*")

'''
	# Finance App 💰
	*Welcome to a personal finance app tailored for Fidelity users, providing detailed insights into your 
	spending and saving habits and investments. This app is designed to help you understand your progress 
	and guide you towards your financial goals.*
	...
	analyses, simply navigate to the desired analysis on the sidebar and make sure that your spending and/or investments
	transactions file is formatted exactly as the example files. Once this has been verified, upload the file and analyses
	will be automatically performed on this data. To see what analyses are performed, click on the example button.

	***Note:*** To ensure that all your financial data is included in the analysis, make sure to link your Fidelity 
	and non-Fidelity accounts within Fidelity's platform. This will allow you to consolidate transactions and investments 
	from multiple institutions.

	### How it Works
	To make managing finances easier, I have integrated a simple way to download transactions and investments 
	across all accounts, primarily using Fidelity. Before By following a few steps, you can gather all your financial 
	data without extra charges:
	Downloading Spending Transactions::
	1. Log into [Fidelity](https://digital.fidelity.com/ftgw/digital/plan-summary/summary)
